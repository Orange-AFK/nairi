...
1. Status: completed and merged through Admin Edit Metadata JSON Field Boundary.
...
3. Next candidate: publish-request persistence when selected, a separate published-history/list module if product wants it, or another narrow admin edit boundary.
