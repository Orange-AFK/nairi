...
1. Status: completed through admin publish review status scope boundary.
...
3. Next candidate: Admin Router Adoption Boundary, richer edit metadata fields, publish-request persistence when selected, or a separate published-history/list module if product wants it.
