...
3. Active next candidate: Cloudflare Live Execution Design Boundary if live provider behavior is prioritized; otherwise local repair tooling dry-run implementation or CMS Admin Console Foundation.
