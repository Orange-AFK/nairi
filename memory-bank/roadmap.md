...
1. Status: runtime API client boundary completed through Admin Publish Request Persistence Boundary.
...
5. Current detailed admin status is tracked in `Admin Runtime API Client Boundary`; next admin candidate is a publish-request resolve workflow, or a separate published-history/list module if product wants it.
...
1. Status: completed and merged through Admin Publish Request Persistence Boundary.
...
3. Next candidate: publish-request resolve workflow, a separate published-history/list module if product wants it, or another narrow admin edit boundary.
