...
10. `unreadable_evidence_bundle`: the evidence file cannot be read or parsed by the CLI.
11. `invalid_evidence_bundle`: the evidence file is valid JSON but is not a JSON object.
