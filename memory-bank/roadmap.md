...
3. Active next candidate: Cloudflare Live Execution Design Boundary if live provider behavior is prioritized; otherwise executable repair tooling design or CMS Admin Console Foundation.
